...
namespace TheCheckoutKata.CheckoutItems
{
    public class Checkout(PricingRules pricingRules) : ICheckout
    {
        ...
        public int GetTotalPrice()
        {
            ...
            {
                totalPrice = AddToTotalPrice(pricingRules, totalPrice, item);
            }

            return totalPrice;
        }

        private static int AddToTotalPrice(PricingRules pricingRules, int totalPrice, KeyValuePair<string, int> item)
        {
